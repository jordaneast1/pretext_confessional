...
export function layoutNextLine(
  ...
  function finishLine(
    ...
    return materializeLayoutLine(prepared, graphemeCache, {
      startSegmentIndex: lineStartSegmentIndex,
      startGraphemeIndex: lineStartGraphemeIndex,
      endSegmentIndex,
      endGraphemeIndex,
  ...
  function appendBreakableSegmentFrom(segmentIndex: number, startGraphemeIndex: number): LayoutLine | null {
    const gWidths = breakableWidths[segmentIndex]!
    for (let g = startGraphemeIndex; g < gWidths.length; g++) {
      const gw = gWidths[g]!
  ...
  function maybeFinishAtSoftHyphen(segmentIndex: number): LayoutLine | null {
